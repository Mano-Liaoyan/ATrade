    ...
    extend: {
      colors: {
        ...
        terminal: {
          ...
          "border-strong": "hsl(var(--terminal-border-strong))",
          grid: "hsl(var(--terminal-chart-grid))",
          splitter: "hsl(var(--terminal-splitter))",
          "splitter-active": "hsl(var(--terminal-splitter-active))",
          ...
          orange: "hsl(var(--terminal-accent-orange))",
          ...
          focus: "hsl(var(--terminal-focus-ring))",
        },
        status: {
