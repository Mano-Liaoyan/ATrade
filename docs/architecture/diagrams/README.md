...
| 7 | [Operations, Taskplane, And Safety](07-operations-taskplane-and-safety.md) | Process and guardrail diagrams | Documentation authority, Taskplane/Pi coordination, verification entry points, runtime secrets, and paper-only safety rules. |

## Coverage Matrix

| Project Area | Primary Diagrams | Notes |
| --- | --- | --- |
| Human/operator workflow | [01](01-system-context.md), [07](07-operations-taskplane-and-safety.md) | Covers the local trader/operator, GitHub/Taskplane coordination, docs authority, and verification net. |
| Startup and orchestration | [02](02-local-runtime-and-deployment.md), [07](07-operations-taskplane-and-safety.md) | Covers Unix, PowerShell, and Command Prompt shims, `.env` precedence, Compose-managed infrastructure, Aspire app services, and dashboard telemetry. |
...
| Provider safety | [04](04-provider-and-market-data-flows.md), [05](05-analysis-and-backtesting-flows.md), [07](07-operations-taskplane-and-safety.md) | Covers provider-neutral payloads, safe unavailable states, no synthetic production data, no secret leaks, and no live order placement. |
| Testing and verification | [07](07-operations-taskplane-and-safety.md) | Points readers to the solution, start-wrapper, AppHost/Compose, backend contract, and frontend regression verification families. |
