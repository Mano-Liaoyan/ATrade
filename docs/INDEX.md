...
| [`design/atrade-terminal-ui.md`](design/atrade-terminal-ui.md)                       | maintainer | Active clean-room ATrade paper workspace UI design authority for the direct module/workflow frontend.                                    |
...
| [`architecture/backtesting.md`](architecture/backtesting.md)                         | maintainer | Provider-neutral saved backtesting module, Postgres persistence, capital snapshots, REST API, and safety contract.                    |
