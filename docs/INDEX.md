...
| ------------------------------------------------------------------------------------ | ---------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| [`../README.md`](../README.md)                                                       | maintainer | Human-facing overview of the current ATrade application, run contract, and active implementation direction.                             |
| [`../AGENTS.md`](../AGENTS.md)                                                       | maintainer | Repository guidance and introduction of repo-local agent skills.                                                                        |
...
| [`design/atrade-terminal-ui.md`](design/atrade-terminal-ui.md)                       | maintainer | Active clean-room ATrade paper workspace UI design authority, including the progressive saved-run BACKTEST workflow.                     |
...
| [`architecture/backtesting.md`](architecture/backtesting.md)                         | maintainer | Provider-neutral saved backtesting module, Postgres persistence, capital snapshots, REST/API hub contracts, UI validation, and safety. |
| [`architecture/diagrams/README.md`](architecture/diagrams/README.md)                 | maintainer | Visual architecture diagram table of contents covering system context, runtime, modules, providers, backtesting, frontend, operations, and safety. |
...
| [`process/github-coordination.md`](process/github-coordination.md)                   | maintainer | Lightweight GitHub coordination contract for repository work.                                                                           |
...
- Historical planning artifacts are not active implementation authority unless listed above.
