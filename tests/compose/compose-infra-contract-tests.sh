...
assert_compose_static_contract() {
  ...
  assert_file_contains "$compose_file" 'POSTGRES_DB: atrade'
  assert_file_contains "$compose_file" 'POSTGRES_USER: atrade'
  assert_file_contains "$compose_file" 'POSTGRES_DB: atrade_marketdata'
