...
assert_simplified_workspace_source_contract() {
  ...
  assert_file_contains "$app" '<TerminalSearchModule onOpenIntent={onOpenIntent} searchQuery={searchQuery} />'
  assert_file_contains "$app" '<TerminalWatchlistModule onOpenIntent={onOpenIntent} />'
...
PY
  ...
  assert_file_contains "$root_response" 'data-scroll-owner="primary-workspace"'
  assert_file_contains "$root_response" 'data-scroll-owner="module-rail"'
  ...
  assert_file_contains "$chart_response" 'data-scroll-owner="primary-workspace"'
  assert_file_contains "$chart_response" 'data-scroll-owner="chart-module"'
