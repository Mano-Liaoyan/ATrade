...
assert_removed_top_chrome_source_contract() {
  ...
  assert_file_contains "$app" '<TerminalHomeModule onOpenIntent={onOpenIntent} searchQuery={searchQuery} />'
...
PY
  ...
  assert_file_contains "$repo_root/frontend/components/terminal/TerminalSearchModule.tsx" 'data-testid="terminal-search-primary-workflow"'
  assert_file_contains "$repo_root/frontend/components/terminal/MarketMonitorFilters.tsx" 'aria-label="Market monitor filters"'
  assert_file_contains "$repo_root/frontend/components/terminal/MarketMonitorFilters.tsx" 'Filter rows'
  assert_file_contains "$repo_root/frontend/components/terminal/MarketMonitorFilters.tsx" 'Clear all'
