...
assert_market_data_provider_source_contract() {
  ...
  assert_file_contains "$repo_root/src/ATrade.MarketData.Ibkr/IbkrMarketDataClient.cs" 'ByteArrayContent'
  assert_file_contains "$repo_root/src/ATrade.MarketData.Ibkr/IbkrMarketDataClient.cs" 'ContentLength'
  assert_file_contains "$repo_root/src/ATrade.MarketData.Ibkr/IbkrMarketDataClient.cs" 'TransferEncodingChunked = false'
  assert_file_contains "$repo_root/tests/ATrade.MarketData.Ibkr.Tests/IbkrScannerRequestContractTests.cs" 'Content.Headers.ContentLength'
  assert_file_contains "$repo_root/tests/ATrade.MarketData.Ibkr.Tests/IbkrScannerRequestContractTests.cs" 'TransferEncodingChunked'
