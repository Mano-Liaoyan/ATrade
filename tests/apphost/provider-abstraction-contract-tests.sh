...
main() {
  ...
  local ibkr_market_data_project="$repo_root/src/ATrade.MarketData.Ibkr/ATrade.MarketData.Ibkr.csproj"
  ...
  assert_file_contains "$ibkr_market_data_project" 'ATrade.Brokers.Ibkr.csproj'
  ...
  assert_file_contains "$api_program" 'AddIbkrMarketDataProvider'

  assert_file_not_contains "$market_module" 'MockMarketData'
  assert_file_not_contains "$market_module" 'AddSingleton<IMarketDataProvider>'
  assert_file_contains "$market_module" 'AddSingleton<IMarketDataService, MarketDataService>()'
  assert_file_not_contains "$market_module" 'AddSingleton<IMarketDataStreamingProvider>'
  ...
  assert_file_contains "$repo_root/src/ATrade.MarketData.Ibkr/IbkrMarketDataProvider.cs" ': IMarketDataProvider, IMarketDataStreamingProvider'
  assert_file_contains "$repo_root/src/ATrade.MarketData.Ibkr/IbkrMarketDataProvider.cs" 'UsesMockData: false'
  assert_path_not_exists "$repo_root/src/ATrade.MarketData/MockMarketDataService.cs"
  assert_path_not_exists "$repo_root/src/ATrade.MarketData/MockMarketDataStreamingService.cs"
}
