...
assert_frontend_dependencies_and_source() {
  ...
  assert_file_contains "$repo_root/frontend/components/TradingWorkspace.tsx" 'useWatchlistWorkflow'
  ...
  assert_file_contains "$repo_root/frontend/components/TradingWorkspace.tsx" 'getSearchResultPinState'
  assert_file_contains "$repo_root/frontend/components/TradingWorkspace.tsx" 'getTrendingPinState'
  assert_file_contains "$repo_root/frontend/components/TradingWorkspace.tsx" 'getWatchlistSymbolPinState'
  assert_file_not_contains "$repo_root/frontend/components/TradingWorkspace.tsx" "from '../lib/watchlistClient'"
  assert_file_not_contains "$repo_root/frontend/components/TradingWorkspace.tsx" "from '../lib/watchlistStorage'"
  ...
  assert_file_contains "$repo_root/frontend/components/SymbolSearch.tsx" 'useSymbolSearchWorkflow'
  assert_file_contains "$repo_root/frontend/components/SymbolSearch.tsx" 'getPinState'
  assert_file_not_contains "$repo_root/frontend/components/SymbolSearch.tsx" 'pinnedSet'
  assert_file_not_contains "$repo_root/frontend/components/SymbolSearch.tsx" 'searchSymbols'
  ...
  assert_file_contains "$repo_root/frontend/components/Watchlist.tsx" 'key={pinState.pinKey}'
  assert_file_contains "$repo_root/frontend/components/Watchlist.tsx" 'getPinState'
  ...
  assert_file_contains "$repo_root/frontend/components/SymbolChartView.tsx" 'useSymbolChartWorkflow'
  assert_file_contains "$repo_root/frontend/components/SymbolChartView.tsx" 'Search another IBKR stock'
  assert_file_not_contains "$repo_root/frontend/components/SymbolChartView.tsx" 'connectMarketDataStream'
  assert_file_not_contains "$repo_root/frontend/components/SymbolChartView.tsx" 'fallbackTimer = window.setInterval'
