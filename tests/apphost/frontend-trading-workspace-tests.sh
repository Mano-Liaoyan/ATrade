...
assert_frontend_dependencies_and_source() {
  ...
  assert_file_contains "$repo_root/frontend/components/terminal/ATradeTerminalApp.tsx" 'useSymbolChartWorkflow'
  assert_file_contains "$repo_root/frontend/components/terminal/ATradeTerminalApp.tsx" 'Chart range lookback controls'
  ...
  assert_file_contains "$repo_root/frontend/components/terminal/ATradeTerminalApp.tsx" '<AnalysisPanel'
}
...
start_frontend_and_assert_markers() {
  ...
  assert_file_contains "$chart_response" 'No live orders'
