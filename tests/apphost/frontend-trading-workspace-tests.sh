...
assert_frontend_dependencies_and_source() {
  ...
  assert_file_contains "$repo_root/frontend/components/terminal/ATradeTerminalApp.tsx" 'TerminalHomeModule'
  assert_file_contains "$repo_root/frontend/components/terminal/TerminalHomeModule.tsx" 'Paper trading command overview'
  assert_file_contains "$repo_root/frontend/components/terminal/TerminalSearchModule.tsx" 'Search-first workflow'
  assert_file_contains "$repo_root/frontend/components/terminal/TerminalWatchlistModule.tsx" 'Saved-stocks workflow'
...
start_frontend_and_assert_markers() {
  ...
  assert_file_contains "$root_response" 'Home dashboard'
  ...
  assert_file_contains "$root_response" 'Provider trending preview'
  assert_file_contains "$root_response" 'Watchlist preview'
